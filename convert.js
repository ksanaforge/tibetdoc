...
if (typeof module!="undefined") {
	module.exports={TibetDocJSONToHTML:TibetDocJSONToHTML, TibetDocParse:TibetDocParse};
	if (process.argv.length>2)	 {
		convertFile(process.argv[2]);
	}

} else {
	window.TibetDocParse=TibetDocParse;
	window.TibetDocJSONToHTML=TibetDocJSONToHTML;
}